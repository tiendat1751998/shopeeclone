...
func Load() *Config {
	return &Config{AppName: getEnv("APP_NAME", "shopee-search"), AppEnv: getEnv("APP_ENV", "development"), LogLevel: getEnv("LOG_LEVEL", "info"), HTTPPort: getEnvInt("SEARCH_HTTP_PORT", 8080), GRPCPort: getEnvInt("SEARCH_GRPC_PORT", 9090),
		...
		OpenTelemetry: OTELConfig{Endpoint: getEnv("OTEL_EXPORTER_OTLP_ENDPOINT", "http://localhost:4318"), ServiceName: getEnv("OTEL_SERVICE_NAME", "shopee-search"), TraceRatio: getEnvFloat("OTEL_TRACES_SAMPLER_ARG", 0.1)}}
}
