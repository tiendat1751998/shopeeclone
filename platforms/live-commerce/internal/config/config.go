...
func Load() *Config {
	return &Config{AppName: "shopee-live-commerce", AppEnv: "development", LogLevel: "info", HTTPPort: 8080, GRPCPort: 9090,
		...
		OpenTelemetry: OTELConfig{Endpoint: "http://localhost:4318", ServiceName: "shopee-live-commerce", TraceRatio: 0.1}}
}
